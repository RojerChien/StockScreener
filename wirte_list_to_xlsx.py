...
dfus = pd.DataFrame(us_tickers)
dftw = pd.DataFrame(tw_tickers)
dfetf = pd.DataFrame(etf_tickers)
dfus.to_excel("Tickers_US.xlsx", sheet_name="US", index=False, header=False)
dftw.to_excel("Tickers_TW.xlsx", sheet_name="TW", index=False, header=False)
dfetf.to_excel("Tickers_ETF.xlsx", sheet_name="ETF", index=False, header=False)
